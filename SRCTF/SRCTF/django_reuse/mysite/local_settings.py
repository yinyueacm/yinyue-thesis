...
ACCOUNT_SIGNUP_FORM_CLASS = 'project.views.SignupForm'
...
# Determines whether or not the user is automatically logged out by a mere 
# GET request. See documentation for the LogoutView for details.
ACCOUNT_LOGOUT_ON_GET = True

# The URL (or URL name) to return to after the user logs out. This is the 
# counterpart to Django's LOGIN_REDIRECT_URL.
